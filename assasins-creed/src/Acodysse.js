...
const Acodysse = () => {
    ...
    const poster = "https://www.hutmobile.com/wp-content/uploads/2020/11/1-71.jpg";
  return (
    <div className='bg-gray-600' >
<div className=" ">
    
<img src="https://wallpaperaccess.com/full/1110196.jpg" 
...
<Button variant='outlined' className='final' >
    ...
    <div className="mt-[27px] text-2xl font-semibold text-[#E0AA3E] shadow-xl shadow-gray-500/50 "> <h1>Assasins Creed odyssey </h1></div>
    <div className="mt-[10px] text-[#E0AA3E] shadow-xl font-bold "> Price : 24.99 $ </div>
